...
Object.assign(LOOKS, {
  skin: [
    { id:"#e8b98a", name:"Clara" }, { id:"#f5d0a9", name:"Muy clara" }, { id:"#c68e5e", name:"Morena" },
  ...
  weaponGlow: [
    { id:"auto", name:"El de tu arma" }, { id:"#6ef0ff", name:"Cian", need:{ level:20 } }, { id:"#ff3a4a", name:"Carmesí", need:{ kills:1500 } },
...
const LOOK_CAT = { outfit:"Conjunto", armor:"Armadura", hair:"Peinado", hairColor:"Color de pelo", eyes:"Ojos", skin:"Piel",
                   height:"Altura", head:"Cabeza", back:"Espalda", weaponGlow:"Brillo del arma", cape:"Capa", aura:"Aura" };
const LOOK_DEFAULT = { outfit:"hunter", armor:"light", hair:"hood", hairColor:"#15121f", eyes:"#4a5a78", cape:"none", aura:"none",
                       skin:"#e8b98a", height:"1.06", head:"none", back:"none", weaponGlow:"auto" };
function needMet(n){
  if (!n) return true;
