...
Dos aplicaciones web independientes, cada una en un solo archivo HTML, sin dependencias ni build.

| Proyecto | Qué es |
|---|---|
| [**🤖 NEXO IA**](ia/) — `ia/index.html` y `ia/nexo-en-linea.html` | Asistente de IA con Claude Opus 5: responde, busca en la web, razona a la vista, lee imágenes y PDFs, y crea imágenes. Instalable como app. Necesita tu clave de la API de Anthropic. |
